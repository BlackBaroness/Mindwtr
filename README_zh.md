...
<div align="center">
  ...
  <p><i>在电脑和手机上记录、整理、专注执行</i></p>
</div>

## 怎么用

把「筹备妈妈的生日」或「有空学吉他」记下来，再决定怎么处理。Mindwtr 会引导你走完这个过程，不需要先学会 GTD。

1. **先记下来。** 用桌面快捷键、手机小组件或系统分享，把任务和想法放进收件箱。
2. **想清下一步。** 把大计划拆成具体行动，用「等待中」跟进别人答应的事，把暂时不做的想法放进「将来/也许」。
3. **选一件去做。** 打开「聚焦」，查看今天的日程和下一步行动，按所处的地点或手边的工具筛选。
4. **每周回顾。** 跟着回顾向导检查项目、跟进等待事项，整理遗漏的任务。
...
[网站上的全部视频](https://docs.mindwtr.app/start/videos) · [YouTube 频道](https://www.youtube.com/@mindwtr)

想了解方法本身，可以阅读 [15 分钟入门 GTD](https://hamberg.no/gtd)，或[查看交互式 GTD 流程图](https://docs.mindwtr.app/assets/diagrams/gtd-workflow)。
...
- **电脑和手机都能用。** Windows、macOS、Linux、iPhone、iPad 和 Android 都支持完整的 GTD 流程，并提供 22 种语言选项。
...
[**查看全部功能 →**](https://mindwtr.app/features)

## 为什么选择 Mindwtr（快速对比）

Mindwtr 适合想在一个应用里用上完整 GTD 方法、并且数据完全归自己的人。下面是与几款待办应用的快速对比。
...
[查看完整对比与来源 →](https://mindwtr.app/compare)
...
需要连接其他工具？Mindwtr 提供[本地 API](https://docs.mindwtr.app/power-users/local-api) 和 [MCP 服务器](https://docs.mindwtr.app/power-users/mcp)，也支持[自行部署网页版与同步服务器](https://docs.mindwtr.app/data-sync/cloud-deployment)。这些都是可选的。
